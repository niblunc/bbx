...
if __name__ == "__main__":
    #commandline parser
    parser=argparse.ArgumentParser(description='onset file generator for bbx')
    ...
    parser.add_argument('-outpath', dest='outpath', action='store_true',
                       default=False, help='output directory path')
    parser.add_argument('-input', dest='input', action='store_true',
			default=False, help='input directory path')
